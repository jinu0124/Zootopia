...
public class Driver {
	public static void main(String[] args) {
		...
		try {
			...
			pgd.addClass("wordcount1char", Wordcount1char.class, "A map/reduce program that performs word counting the 1st.");
			...
			pgd.addClass("matadd", MatrixAdd.class, "A map/reduce program that computes the addition of two matrixes");
